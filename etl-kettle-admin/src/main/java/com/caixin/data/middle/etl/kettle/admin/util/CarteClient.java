 ...
 * FileName: CarteClient
 * Author:   zhuzj29042
 * Date:     2020/2/10 15:55::12
 * Description:
 * History:
...
import com.caixin.data.middle.etl.kettle.admin.util.task.HttpClientUtil;
import com.caixin.data.middle.etl.kettle.admin.entity.SlaveEntity;
//import com.caixin.data.middle.etl.kettle.monitor.util.task.HttpClientUtil;
...
//        BasicDataSource dataSource = (BasicDataSource) applicationContext.getBean("dataSource");
        DruidDataSource dataSource = (DruidDataSource) applicationContext.getBean(DataSource.class);
