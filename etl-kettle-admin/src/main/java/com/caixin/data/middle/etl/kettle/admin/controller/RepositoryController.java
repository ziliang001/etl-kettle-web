...
import com.caixin.data.middle.etl.kettle.admin.bean.RepositoryCheckNode;
import com.caixin.data.middle.etl.kettle.admin.bean.RepositoryNode;
import com.caixin.data.middle.etl.kettle.admin.bean.RepositoryNodeType;
...
//import com.caixin.data.middle.etl.kettle.admin.repository.beans.RepositoryNodeType;
import com.caixin.data.middle.etl.kettle.ext.PluginFactory;
import com.caixin.data.middle.etl.kettle.ext.base.GraphCodec;
import com.caixin.data.middle.etl.kettle.ext.cluster.SlaveServerCodec;
import com.caixin.data.middle.etl.kettle.ext.core.database.DatabaseCodec;
import com.caixin.data.middle.etl.kettle.ext.repository.RepositoryCodec;
        ...
        try {
            ...
            if(null!=taskGroupArray && taskGroupArray.length>0){
                ...
                for(String taskGroupName:taskGroupArray){
                    ...
                    sqlSession.insert("com.caixin.data.middle.etl.kettle.admin.dao.TaskGroupDao.addTaskGroupAttribute",attr);
                }
                sqlSession.commit();
                sqlSession.close();
            }
