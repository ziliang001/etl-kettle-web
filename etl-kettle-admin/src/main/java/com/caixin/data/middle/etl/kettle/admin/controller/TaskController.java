...
import com.caixin.data.middle.etl.kettle.admin.entity.*;
...
import com.caixin.data.middle.etl.kettle.admin.util.TransExecutor;
...
import com.caixin.data.middle.etl.kettle.admin.service.JobService;
import com.caixin.data.middle.etl.kettle.admin.service.SlaveService;
import com.caixin.data.middle.etl.kettle.admin.service.TransService;
import com.caixin.data.middle.etl.kettle.ext.PluginFactory;
import com.caixin.data.middle.etl.kettle.ext.base.GraphCodec;
import com.caixin.data.middle.etl.kettle.ext.job.JobExecutionConfigurationCodec;
import com.caixin.data.middle.etl.kettle.ext.trans.TransExecutionConfigurationCodec;
...
public class TaskController {
    ...
    protected void powerExecute(HttpServletResponse response,HttpServletRequest request) throws Exception{
        ...
        if(minSlave==null){
            ...
            if(flag.equals("job")){
                ...
                com.caixin.data.middle.etl.kettle.ext.util.JSONObject jsonObject = com.caixin.data.middle.etl.kettle.ext.util.JSONObject.fromObject(json.toString());
    ...
    protected void detail(@RequestParam String taskName,@RequestParam String type) throws Exception {
        com.caixin.data.middle.etl.kettle.ext.util.JSONObject jsonObject = new com.caixin.data.middle.etl.kettle.ext.util.JSONObject();
