...
import com.caixin.data.middle.etl.kettle.admin.dao.*;
import com.caixin.data.middle.etl.kettle.admin.entity.*;
import com.caixin.data.middle.etl.kettle.admin.util.App;
import com.caixin.data.middle.etl.kettle.admin.util.CarteClient;
import com.caixin.data.middle.etl.kettle.admin.util.CarteTaskManager;
...
//import com.caixin.data.middle.etl.kettle.monitor.util.task.KettleEncr;
...
public class JobServiceImpl implements JobService {
    ...
    public JSONObject findJobs(int start, int limit, String name, String createDate, String userGroupName) throws Exception{
        ...
        result= JSONObject.fromObject(pages, StringDateUtil.configJson("yyyy-MM-dd HH:mm:ss"));
        return result;
    }
    ...
    public void addTimeExecuteJob(String graphXml,String executionConfiguration,HttpServletRequest request) throws Exception {
        ...
        com.caixin.data.middle.etl.kettle.ext.util.JSONObject jsonObject = com.caixin.data.middle.etl.kettle.ext.util.JSONObject.fromObject(executionConfiguration);
